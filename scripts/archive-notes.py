...
def main():
    ...
    # label-সামঞ্জস্য: প্রথম রাখা এন্ট্রিটা সবসময় "সর্বশেষ commit" বলবে —
    # এটা আগে থেকেই "তার আগের commit" দিয়ে শুরু হয়ে থাকলেও (যেমন কোনো
    # ম্যানুয়াল এডিট/merge-এর পর ভুলবশত হতে পারে) প্রমোট করে দেওয়া হয়,
    # নাহলে archive করার পর কোনো এন্ট্রিই "সর্বশেষ" না বলার একটা bug হতো
    # (টেস্ট করে ধরা পড়েছে)। বাকি রাখা এন্ট্রিগুলো (যদি কোনো কারণে
    # "সর্বশেষ" দিয়ে শুরু হয়ে থাকে) "তার আগের commit"-এ বদলে দেওয়া হয়।
    keep[0] = re.sub(r"^\*\*তার আগের commit", "**সর্বশেষ commit", keep[0], count=1)
