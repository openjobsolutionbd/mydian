    ...
    for (const entry of entries) {
      ...
      try {
        ...
        if (err.message && err.message.includes("has already been changed elsewhere")) {
          ...
          // আগে এখানে সব ধরনের ব্যর্থতাকেই "নেট এখনো ফেরেনি" ধরে নিয়ে
          // পুরো loop `break` করে দেওয়া হতো — কিন্তু এই একই ব্যর্থতা
          // অন্য কোনো নির্দিষ্ট কারণেও হতে পারে যেটা শুধু এই একটা
          // ফাইলের সমস্যা (যেমন ফাইলটা এর মধ্যে remote-এ ডিলিট হয়ে
          // গেছে) — সেক্ষেত্রে বাকি pending এন্ট্রিগুলোর (যাদের আসলে
          // কোনো সমস্যাই নেই) সিঙ্ক হওয়ার সুযোগই আর পেত না, একটা খারাপ
          // এন্ট্রি পুরো ব্যাচ আটকে দিত। এখন `continue` করে বাকি
          // এন্ট্রিগুলোতেও চেষ্টা করা হচ্ছে — সত্যিই অফলাইন হলে সেগুলোও
          // দ্রুত একে একে একই কারণে ব্যর্থ হবে (loop এখনো ঠিক সময়েই
          // শেষ হবে), কিন্তু আসলে সিঙ্ক হতে পারত এমন এন্ট্রি আর
          // অহেতুক আটকে থাকবে না।
