...
**সর্বশেষ commit:** অফলাইন-ফার্স্ট IndexedDB ক্যাশ (নতুন ফিচার) +
GitHub-এ ম্যানুয়ালি আপলোড করা "নাম পরিবর্তন" ফিচারের সাথে merge
**তারিখ:** ২০২৬-০৮-০৯
**অবস্থা:** ইউজার জানিয়েছেন তার মূল লক্ষ্য হলো অ্যাপ যেন দ্রুত (fast)
হয় এবং .md ফাইল Obsidian-মানের এক্সপেরিয়েন্সে থাকে। এর প্রথম ও
সবচেয়ে বড় ধাপ হিসেবে অফলাইন-ফার্স্ট লোকাল ক্যাশ যোগ করা হয়েছে। ইউজার
কোনো টেকনিক্যাল ব্যাখ্যা চান না — শুধু কাজ করা অ্যাপ চান, তাই ভবিষ্যতে
এই প্রজেক্টে কাজ করার সময় ব্যাখ্যা সংক্ষিপ্ত রাখা উচিত।

**এই রাউন্ডে যা যোগ হয়েছে:**
