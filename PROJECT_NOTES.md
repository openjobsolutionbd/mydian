...
**সর্বশেষ commit (২০২৬-০৮-১২):** ডার্ক মোডে এডিটরে টাইপ করার সময়
...
**তার আগের commit (২০২৬-০৮-১২):** আগের commit-এ শুধু OS থেকে sidebar-এ
ফাইল আনা যেত, কিন্তু sidebar-এর ভেতরেই একটা বিদ্যমান ফাইল/ফোল্ডার টেনে
অন্য ফোল্ডারে সরানো (move) যেত না — ইউজার স্ক্রিনশট দিয়ে এই সমস্যাটা আর
সাথে ডান পাশে একটা বেমানান সাদা স্ক্রলবার-বক্স রিপোর্ট করেছিলেন। দুটোই
ঠিক করা হয়েছে:
