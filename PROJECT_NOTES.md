...
**সর্বশেষ commit (২০২৬-০৮-১৩):** "সর্বশেষ অবস্থা" সেকশন স্বয়ংক্রিয়ভাবে
...
- আগে একবার ম্যানুয়ালি একই কাজ করা হয়েছিল (১০টা পুরনো এন্ট্রি সরিয়ে
  PROJECT_NOTES.md 64KB থেকে 28KB-এ নামানো হয়) — এই স্ক্রিপ্টটা এখন
  থেকে সেটা নিজে থেকেই বজায় রাখবে, ফাইল আর বড় হতে দেবে না।

**তার আগের commit (২০২৬-০৮-১৩):** Quick switcher যোগ হয়েছে —
